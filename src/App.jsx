...
import { money, fmtDate, buildPriceHistory, lastNHistory, weightedAvgPrice } from "./logic/pricingEngine.js";
import { computeTotals, readinessScore, scoreColor } from "./logic/readinessScore.js";
...
export default function App(){
  ...
  // Browser auto-save retained: quotes persist on refresh/reopen.
...
{historySku ? (
        <PriceHistoryModal historySku={historySku} historyRows={historyRows} onClose={()=>setHistorySku(null)} Modal={Modal} />
      ) : null}
